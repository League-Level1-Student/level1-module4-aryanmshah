...
JOptionPane.showConfirmDialog(null,"Press the matching key when simon says. otherwise press another key.");
...
if(tries>4) {
	...
	speak("Well done Ponton your score was" +points);
	frame.dispose();
	System.exit(0);
}
